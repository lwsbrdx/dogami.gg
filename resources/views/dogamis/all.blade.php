...
<div class="mx-auto justify-items-center grid grid-cols-2 w-80 sm:grid-cols-3 sm:w-[500px] lg:grid-cols-4 lg:w-[680px] xl:grid-cols-6 xl:w-[1080px] gap-x-0 gap-y-4 sm:gap-4 max-w-full">
    @empty($dogamis)
